...
curl --silent -k -X GET "https://52.188.183.99:12137/properties" > actual.txt
...
curl --silent -k -X PUT "https://52.188.183.99:12137/properties/$OLDESTRECORD" \
--header 'x-api-key: cs4783FTW' \
--data-raw '{"address": "123 Test ave", "city": "New York", "state": "NY", "zip": "899999"}' > actual.txt
...
curl --silent -k -X GET "https://52.188.183.99:12137/properties/$OLDESTRECORD" > actual.txt
...
curl --silent -k -X DELETE "https://52.188.183.99:12137/properties/$OLDESTRECORD" > actual.txt
if grep "{\"message\":\"ERROR: Unauthorized\"}" actual.txt; then
    let FOUND=1
else
    let FOUND=0
...
curl --silent -k -X DELETE "https://52.188.183.99:12137/properties/$OLDESTRECORD" \
...
curl --silent -k -X GET "https://52.188.183.99:12137/properties/one" > actual.txt

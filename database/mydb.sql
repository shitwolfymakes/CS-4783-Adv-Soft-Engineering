...
INSERT INTO `tbl_properties_test`(`ID`, `address`, `city`, `state`, `zip`) VALUES (NULL,"234 Valid? St.","San Diego","CA","12345")
INSERT INTO `tbl_properties_test`(`ID`, `address`, `city`, `state`, `zip`) VALUES (NULL,"177 Bleecker St.","New York City","NY","10012")